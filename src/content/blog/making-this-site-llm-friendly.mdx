...
## 6. Rendering details still matter

While building this out, a standard frontend detail immediately popped up on a technical post with code samples: **lists need explicit markers.**

Tailwind resets list styles by default. If your prose styles don't explicitly restore them, your bulleted and ordered lists will either look broken or disappear entirely.
